...
- Màn hình nhập kho tổng chỉ ghi số bao; không chốt hóa đơn tại đây. HTKD chốt kg từng bao, giá, phí và VAT trên phiếu cửa hàng sau khai nhận. Chi phí nhà cung cấp lịch sử và endpoint confirm-costs vẫn giữ để tương thích consumer API; không chuyển trạng thái COST_PENDING, không đặt chi phí 0, không sao chép chi phí hóa đơn sang phiếu cửa hàng.
